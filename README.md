...
In summary, Reactive Streams is a standard and specification for Stream-oriented libraries that
...
This project is a collaboration between engineers. The code is offered to the Public Domain in order to allow free use by interested parties who want to create compatible implementations. For details see `COPYING`.
...
<p xmlns:dct="http://purl.org/dc/terms/" xmlns:vcard="http://www.w3.org/2001/vcard-rdf/3.0#">
  ...
  <span property="dct:title">Reactive Streams Swift</span>.
